               ...
               int nskp = 5)
{
  ...
  */
  ...
  cgstarWorkingParam residualmat(Sigma,(YY-XB_init), (X.t())*(YY-XB_init), (X.t())*X, mu_old, n );
  ...
  cgstarWorkingParam residualmat_restart=residualmat;
  ...
  cgstarWorkingParam residualmat_left = residualmat;
  ...
  cgstarWorkingParam residualmat_down = residualmat;
  ...
  cgstarWorkingParam residualmat_diag = residualmat;
