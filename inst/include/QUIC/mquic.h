...
inline int IsDiag(int q, arma::mat &A)
{
	int flag = 0;
...
inline void CoordinateDescentUpdate(
...
inline double DiagNewton(int q, const arma::mat &S,
...
inline double projLogDet(int q, const arma::mat &S,
...
inline cube my_quic(const int &q, 
